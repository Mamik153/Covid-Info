...
const Home = () => {
    ...
    return (
        <>
            ...
            <div className='container-fluid home-container' style={{ height: 'fit-content', overflow: 'hidden', fontFamily: 'Poppins', background: '#fff', paddingLeft: 0, marginLeft: 0, marginTop: 0 }}>
